...
// checks if the OktaConnectionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OktaConnectionResponse{}

// OktaConnectionResponse struct for OktaConnectionResponse
type OktaConnectionResponse struct {
	...
	Connectionattributes *OktaConnectionAttributes `json:"connectionattributes,omitempty"`
}
...
func (o *OktaConnectionResponse) GetConnectionattributes() OktaConnectionAttributes {
	if o == nil || IsNil(o.Connectionattributes) {
		var ret OktaConnectionAttributes
		return ret
	}
...
// SetConnectionattributes gets a reference to the given OktaConnectionAttributes and assigns it to the Connectionattributes field.
func (o *OktaConnectionResponse) SetConnectionattributes(v OktaConnectionAttributes) {
	o.Connectionattributes = &v
}

func (o OktaConnectionResponse) MarshalJSON() ([]byte, error) {
...
func (o OktaConnectionResponse) ToMap() (map[string]interface{}, error) {
...
type NullableOktaConnectionResponse struct {
	value *OktaConnectionResponse
	isSet bool
}

func (v NullableOktaConnectionResponse) Get() *OktaConnectionResponse {
	return v.value
}

func (v *NullableOktaConnectionResponse) Set(val *OktaConnectionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOktaConnectionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOktaConnectionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOktaConnectionResponse(val *OktaConnectionResponse) *NullableOktaConnectionResponse {
	return &NullableOktaConnectionResponse{value: val, isSet: true}
}

func (v NullableOktaConnectionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOktaConnectionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
