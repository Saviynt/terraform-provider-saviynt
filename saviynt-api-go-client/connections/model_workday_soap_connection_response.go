...
// checks if the WorkdaySOAPConnectionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkdaySOAPConnectionResponse{}

// WorkdaySOAPConnectionResponse struct for WorkdaySOAPConnectionResponse
type WorkdaySOAPConnectionResponse struct {
	...
	Connectionattributes *WorkdaySOAPConnectionAttributes `json:"connectionattributes,omitempty"`
}
...
func NewWorkdaySOAPConnectionResponse() *WorkdaySOAPConnectionResponse {
	this := WorkdaySOAPConnectionResponse{}
	return &this
}
...
func (o *WorkdaySOAPConnectionResponse) GetConnectionattributes() WorkdaySOAPConnectionAttributes {
	if o == nil || IsNil(o.Connectionattributes) {
		var ret WorkdaySOAPConnectionAttributes
		return ret
	}
...
// SetConnectionattributes gets a reference to the given WorkdaySOAPConnectionAttributes and assigns it to the Connectionattributes field.
func (o *WorkdaySOAPConnectionResponse) SetConnectionattributes(v WorkdaySOAPConnectionAttributes) {
	o.Connectionattributes = &v
}

func (o WorkdaySOAPConnectionResponse) MarshalJSON() ([]byte, error) {
...
func (o WorkdaySOAPConnectionResponse) ToMap() (map[string]interface{}, error) {
...
type NullableWorkdaySOAPConnectionResponse struct {
	value *WorkdaySOAPConnectionResponse
	isSet bool
}

func (v NullableWorkdaySOAPConnectionResponse) Get() *WorkdaySOAPConnectionResponse {
	return v.value
}

func (v *NullableWorkdaySOAPConnectionResponse) Set(val *WorkdaySOAPConnectionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkdaySOAPConnectionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkdaySOAPConnectionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkdaySOAPConnectionResponse(val *WorkdaySOAPConnectionResponse) *NullableWorkdaySOAPConnectionResponse {
	return &NullableWorkdaySOAPConnectionResponse{value: val, isSet: true}
}

func (v NullableWorkdaySOAPConnectionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkdaySOAPConnectionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
