...
// checks if the WorkdayConnectionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkdayConnectionResponse{}

// WorkdayConnectionResponse struct for WorkdayConnectionResponse
type WorkdayConnectionResponse struct {
	...
	Connectionattributes *WorkdayConnectionAttributes `json:"connectionattributes,omitempty"`
}
...
func NewWorkdayConnectionResponse() *WorkdayConnectionResponse {
	this := WorkdayConnectionResponse{}
	return &this
}
...
func (o *WorkdayConnectionResponse) GetConnectionattributes() WorkdayConnectionAttributes {
	if o == nil || IsNil(o.Connectionattributes) {
		var ret WorkdayConnectionAttributes
		return ret
	}
...
// SetConnectionattributes gets a reference to the given WorkdayConnectionAttributes and assigns it to the Connectionattributes field.
func (o *WorkdayConnectionResponse) SetConnectionattributes(v WorkdayConnectionAttributes) {
	o.Connectionattributes = &v
}

func (o WorkdayConnectionResponse) MarshalJSON() ([]byte, error) {
...
func (o WorkdayConnectionResponse) ToMap() (map[string]interface{}, error) {
...
type NullableWorkdayConnectionResponse struct {
	value *WorkdayConnectionResponse
	isSet bool
}

func (v NullableWorkdayConnectionResponse) Get() *WorkdayConnectionResponse {
	return v.value
}

func (v *NullableWorkdayConnectionResponse) Set(val *WorkdayConnectionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkdayConnectionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkdayConnectionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkdayConnectionResponse(val *WorkdayConnectionResponse) *NullableWorkdayConnectionResponse {
	return &NullableWorkdayConnectionResponse{value: val, isSet: true}
}

func (v NullableWorkdayConnectionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkdayConnectionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
