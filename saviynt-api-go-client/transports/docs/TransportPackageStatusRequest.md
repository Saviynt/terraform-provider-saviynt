...
------------ | ------------- | ------------- | -------------
**Operation** | **string** | Type of transport request | 
**Filename** | **string** | Transport package zip file name (including .zip extension) | 
**Requestid** | Pointer to **string** | Request ID generated during import submission (required only if operation is import) | [optional] 
