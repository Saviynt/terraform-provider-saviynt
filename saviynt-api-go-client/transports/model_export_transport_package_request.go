...
// ExportTransportPackageRequest struct for ExportTransportPackageRequest
type ExportTransportPackageRequest struct {
	...
	// Determines if package needs to be exported online
	Exportonline string `json:"exportonline"`
	// Local path where export package will be generated (required if exportonline is false)
	Exportpath string `json:"exportpath"`
	// Name of the environment (required if exportonline is true)
	Environmentname *string                                      `json:"environmentname,omitempty"`
	Objectstoexport ExportTransportPackageRequestObjectstoexport `json:"objectstoexport"`
...
func (o *ExportTransportPackageRequest) GetObjectstoexport() ExportTransportPackageRequestObjectstoexport {
	if o == nil {
		var ret ExportTransportPackageRequestObjectstoexport
		return ret
	}
