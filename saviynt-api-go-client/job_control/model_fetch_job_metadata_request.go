...
// FetchJobMetadataRequest Request body for fetching job metadata
type FetchJobMetadataRequest struct {
	// Name of the job to fetch metadata for
	Jobname string `json:"jobname"`
	// Name of the trigger to fetch metadata for
	Triggername *string `json:"triggername,omitempty"`
	// Group of the job to fetch metadata for
	Jobgroup *string `json:"jobgroup,omitempty"`
	// Start date for the job run
