...
// APIClient manages communication with the Entitlement Type Management API API v1.0.0
...
type APIClient struct {
	...
	EntitlementTypeAPI *EntitlementTypeAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.EntitlementTypeAPI = (*EntitlementTypeAPIService)(&c.common)
