...
// APIClient manages communication with the Saviynt API API v1.0.0
...
type APIClient struct {
	...
	FileDirectoryAPI *FileDirectoryAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.FileDirectoryAPI = (*FileDirectoryAPIService)(&c.common)
